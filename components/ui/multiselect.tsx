...
import { FC, forwardRef, JSX, useEffect } from "react";
...
export type Option = {
  ...
  [key: string]: string | boolean | undefined | FC<{ className: string }>[];
};
                            ...
                            return (
                              <CommandItem
                                ...
                                disabled={
                                  option.disable ||
                                  (selected.find((s) =>
                                    s.value.includes("_level")
                                  ) &&
                                    option.value.includes("_level")) ||
                                  (selected.find((s) =>
                                    s.value.includes("_icon")
                                  ) &&
                                    option.value.includes("_icon") &&
                                    option.value.includes("_icon"))
                                }
                                onMouseDown={(e) => {
                                  e.preventDefault();

...
>(({ className, ...props }, ref) => {
  return (
    <Input
      placeholder=" "
      className={cn(
        "peer h-full w-full rounded-[7px] border border-gray-600 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-gray-600 placeholder-shown:border-t-gray-600 focus:border-2 focus:border-t-0 focus:border-gray-400 focus:border-t-transparent focus:outline-0 focus-visible:ring-0 disabled:border-0 disabled:bg-gray-700",
        className
      )}
      ref={ref}
      {...props}
...
export { Input, FloatingLabelInput, PasswordInput };
